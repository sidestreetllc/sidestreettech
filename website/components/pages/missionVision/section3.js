						...
						<div className="col-lg-12">
							<div className="heading mb-70">
								...
								<p className="s-title text-center text-anime-wave">
									Values That Drive Our Technology <br />
									Approach Commitment
									<span>
										to Excellence
									</span>
							...
							<div className="grid-layout-3">
								...
								<div className="box-icon style-6 type-2 tf-hover-icon ">
									...
									<p className="text">
										At the heart of our managed IT services is a commitment to
								...
								<div className="box-icon style-6 type-2 tf-hover-icon ">
									...
									<p className="text">
										Integrity and transparency are the was cornerstones of our managed IT
