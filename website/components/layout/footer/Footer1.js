									...
									<div className="swiper-wrapper">
										...
										<SwiperSlide>
											<div className="box-cta wow fadeInUp" data-wow-delay="0.2s">
												<p className="caption font-main-2">Want to Put AI to Work?</p>
												<p className="mb-20">Talk to a local Upstate SC team that knows your stack</p>
									...
									<div className="inner-left">
										<div className={`footer-inner-wrap footer-col-block ${isAccordion1 === 1 ? 'open' : ''} `}>
											...
											<ul className="list tf-collapse-content" style={{ display: getDisplayStyle1(1) }}>
												<li>
													<Link href="/service-details">Managed IT & Support</Link>
												</li>
												<li>
													<Link href="/service-details">Cloud & Microsoft 365</Link>
												</li>
												<li>
													<Link href="/service-details">Cybersecurity & Backup</Link>
												</li>
												<li>
													<Link href="/service-details">AI Integration</Link>
												</li>
												<li>
													<Link href="/service-details">AWS & Infrastructure</Link>
												</li>
											</ul>
										</div>
										<div className={`footer-inner-wrap footer-col-block ${isAccordion1 === 1 ? 'open' : ''} `}>
										...
										<div className="logo-site">
											<Link href="/">
												<Image
													...
													id="logo_footer" data-retina="/images/logo/sidestreet-white.png" src="/images/logo/sidestreet-white.png" alt="Sidestreet Technology" />
											</Link>
										</div>
										<p>
